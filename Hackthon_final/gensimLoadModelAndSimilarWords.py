...
#Street outlook (attribute)
w5 = "straatbeeld"
print("top 6 similar words to straatbeeld", model.wv.most_similar(positive=w5,topn=6))


w6 = "tuinuitrusting"
print("top 6 similar words to tuinuitrusting", model.wv.most_similar(positive=w5,topn=6))

#permit disputes , raad vergunnisbetwistinger = council for permit disputes
w7 = "vergunningsbetwistingen"
print("top 6 similar words to vergunningsbetwistingen", model.wv.most_similar(positive=w7,topn=6))
#bovengenoemd = aforementioned, aanhangig = , wenste = client wishes to , samengesteld = , kamer= council, decreetbetreffende= 
